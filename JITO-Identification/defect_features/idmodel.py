...
class Idmodel:
    ...
    def getdata(self, pythonProjectPath):
        data = pd.read_csv(pythonProjectPath+"/defect_features/report/druid.csv")
    ...
    def buildIdmodel(self, pythonProjectPath):
        train, label = self.getdata(pythonProjectPath)
        ...
        np.savetxt(pythonProjectPath+"/train/learnedModel.txt", beta, fmt='%f', delimiter=',')

    def runIdmodel(self, pythonProjectPath):
        data = pd.read_csv(pythonProjectPath + "/defect_features/report/druid_one.csv")
        beta = np.loadtxt(pythonProjectPath+"/train/learnedModel.txt", delimiter=',')
